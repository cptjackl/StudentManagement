...
public partial class StudentRecordContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.StudentId, e.CourseCode }).HasName("PK__Academic__3D052599039A1BB3");
        ...
        {
            entity.HasKey(e => e.Code).HasName("PK__Course__A25C5AA6E222A2E9");
            ...
            entity.HasMany(d => d.StudentStudentNums).WithMany(p => p.CourseCourses)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        j.HasKey("CourseCourseId", "StudentStudentNum").HasName("PK__Registra__92ECCCE921B25B21");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Employee__3214EC07CCE1EA6B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Student__3214EC072F91EA91");
